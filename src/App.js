        ...
        <div className="row firstRow">
          <div className="col-7">
            ...
            <form>
              ...
              <div className="row cvv">
                <div className="col-8">
                  <h5>CVV Number</h5>
                  <span className="enterDigit">Enter the 3 or 4 digit number on the card</span>
                </div>
                <div className="col-4">
              ...
              <div className="row expiryDate">
                <div className="col-6">
                  <h5>Expiry Date</h5>
                  <span className="enterDigit">Enter the expiration date on the card</span>
                </div>
                <div className="col-6 expiryDateDigit row">
                  <div className="col-5">
                  ...
                  <div className="col-5 expiryYearDiv">
                ...
                <div className="password row">
                  <div className="col-6">
                    <h5>Password</h5>
                    <span className="enterDigit">Enter your dynamic password</span>
                  </div>
                  <div className="col-6 passwordInputDiv">
          ...
          <div className="col-5 cardDetails">
            ...
            <div className="row bg">
              ...
              <div className="col-4">
                <p className="blackText">1266201</p>
              </div>
              <div className="col-6">
                <p className="greyText">Product</p>
              </div>
              <div className="col-6">
                <p className="blackText">MacBook Air</p>
              </div>
              <div className="col-6">
                <p className="greyText"> Vat (20%)</p>
              </div>
              <div className="col-6">
                <p className="blackText">$100.00</p>
              </div>
              <img src="/icons/pattern.png" alt="design" className="pattern" />
              <div className="col-12">
                <span className="greyText">You have to pay</span>
              </div>
              <div className="col-8 receiptDiv">
                <p><strong className="blackText">549</strong>.99 <span className="greyText">USD</span></p>
              </div>
              <div className="col-4 invoiceDiv">
